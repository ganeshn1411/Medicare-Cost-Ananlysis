...
*------------------------------------------------------------*;
data WORK.Reg_Average_Submitte_DM;
  length   _TYPE_                           $ 32
           VARIABLE                         $ 32
           LABEL                            $ 256
           FORMAT                           $ 32
...
output;
_TYPE_="TARGET";
VARIABLE="Average_Submitted_Charge_Amount";
LABEL="Average Submitted Charge Amount";
FORMAT="";
LEVEL="INTERVAL";
TYPE="N";
COST="";
USE="";
MIN=0.03848484848484;
MEAN=1070.80865614889;
MAX=81822.2625974026;
output;
_TYPE_="PREDICTED";
VARIABLE="P_Average_Submitted_Charge_Amoun";
LABEL="Predicted: Average_Submitted_Charge_Amount";
FORMAT="";
LEVEL="";
TYPE="N";
COST="";
...
output;
_TYPE_="RESIDUAL";
VARIABLE="R_Average_Submitted_Charge_Amoun";
LABEL="Residual: Average_Submitted_Charge_Amount";
FORMAT="";
LEVEL="";
TYPE="N";
COST="";
...
*------------------------------------------------------------*;
data WORK.Reg_Average_Submitte_DD(label="Average_Submitted_Charge_Amount");
  length   Average_Submitted_Charge_Amount    8
           ;

  label    Average_Submitted_Charge_Amount="Average Submitted Charge Amount"
           ;
Average_Submitted_Charge_Amount=0.03848484848484;
output;
Average_Submitted_Charge_Amount=81822.2625974026;
output;
Average_Submitted_Charge_Amount=1070.80865614889;
output;
;
run;
*------------------------------------------------------------*;
...
filename dspath "&dspath";
file dspath;
put 'if NAME="Average_Submitted_Charge_Amount" then do;';
put 'ROLE="TARGET";';
put 'LEVEL="INTERVAL";';
put 'ORDER="";';
put 'DROP="N";';
...
output;
id= "Reg";
property="EM_DECMETA_Average_Submitted_Charge_Amount";
value= "WORK.Reg_Average_Submitte_DM";
output;
id= "Reg";
property="EM_DECDATA_Average_Submitted_Charge_Amount";
value= "WORK.Reg_Average_Submitte_DD";
output;
id= "Reg";
